...
const About = () => {
  return (
    <div className="flex md:flex-row flex-col justify-between gap-1 items-center p-4 border-b-4">
      <div className="flex flex-col justify-around  rounded-md p-4 md:w-1/2 w-full">
        <h1 className="md:text-4xl text-3xl divide-y-2 divide-slate-400 md:mb-0 text-duskblue-500 ">
          About Me
        </h1>

        <p className="h-auto md:border-l-[8px] border-solid border-slate-500 pl-2 md:mb-0 mb-4 mt-4">
          My name is
